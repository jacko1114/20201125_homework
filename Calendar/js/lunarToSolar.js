const Lunar = function (lunarYear, lunarMonth, lunarDay) {
    this.lunarDay = lunarDay;
    this.lunarMonth = lunarMonth;
    this.lunarYear = lunarYear;
}

const Solar = function (solarYear, solarMonth, solarDay) {
...
const LunarSolarConverter = function () {
    ...
    this.SolarFromInt = function (g) {
        ...
        let mi = parseInt((100 * ddd + 52) / 3060);
        let mm = (mi + 2) % 12 + 1;
        y = y + parseInt((mi + 2) / 12);
        let dd = ddd - parseInt((mi * 306 + 5) / 10) + 1;
        let solar = new Solar();
